/**
 * @file 
 * This is a wrapper class around the different EIG(GT1) classes. It is decided at compile time from which 
 * EIG_* file this class inherits. Compile with PQ to inherit from EIG, compile with PQG to inherit from EIGG, etc. .
 ...
 * @date 23-02-2010\n\n
 * This class, EIG is a "block"-vector over the carrierspace's of the P and Q conditions. It contains room
 ...
 * with random numbers.\n\n
 * This function is the mother class of all EIG* classes.
 */
class EIG
{
   /**
