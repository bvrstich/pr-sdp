...
/**
 * Function used by EIG::centerpot, the distance from the center of the potential with steplength alpha
 * @param alpha steplength
 */
template<class MatrixType>
 ...
 */
template<class MatrixType>
double Vector<MatrixType>::lsfunc(double alpha) const{
